...
description: "Basics for data preparation"
thumbnail: "https://github.com/CarlvinJerry/CarlvinJerry.github.io/blob/master/post/MyImages/Collage%202019-08-04%2002_58_03.jpg?raw=true"
lead: "An introduction to data manipulation and analysis in R"
...
### INTRODUCTION
If you are familiar with data analysis then I'm certain that you fully relate to the above statement. After all, it would be pointless to play around with lots of data just for the love of it.

Data is gold, and the more you have the better off you are. However, raw unprocessed data is of no use unless you manipulate and gain insights from it. Before embarking on statistical modelling and visualization of your data, it is very important to first have an understanding of the data itself. Exploratory Data Analysis (**EDA**) aids in  visualization, transformation, and generally cleaning or remodeling data before diving deep into statistics and predictive modelling.
...
* **Descriptive Statistics** - Give a summarized understanding of the data, usually as measures of central tendency and variability.
...
In this post, we will perform EDA on a sample data set containing responses on mobile banking survey in Kenya. If you would like to follow along with the same data, you can download it [here](https://github.com/CarlvinJerry/sources/blob/master/data/Mobile%20Banking%20in%20Kenya.csv).
...
Once our sample data set loaded, we can check for features present in it. We first need to load all the libraries needed for data analysis and manipulation.
...
<figure>
<img class="pure-u-1-2" src="https://github.com/CarlvinJerry/CarlvinJerry.github.io/blob/master/post/MyImages/packages.png?raw=true" height="100%" width="Auto"> 
...
## [1] 43 11
```
The data set has 43 rows with 11 Variables. We therefore explore the data types present in each variable column.
...
The ***Summary()*** function comes in handy at summarizing data. I our case, there is no statistical measures since all our variables are categorical. Important to note that the function also specifies the specific data types. There are more than enough ways to inspect data structures in R.
