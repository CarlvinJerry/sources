...
<center>
![Figure 1: App login](https://carlvinjerry.github.io/post/MyImages/apps.PNG)  
</center>
...
<center>
 ![Figure 2: Create an app](https://carlvinjerry.github.io/post/MyImages/apps2.PNG)
 </center>
...
<center>
![Figure 3: API Keys](https://carlvinjerry.github.io/post/MyImages/keys.PNG)
 </center>
...
<center>
![Figure 4: Permissions](https://carlvinjerry.github.io/post/MyImages/permisions.PNG)
 </center>
...
With our twitter app set up [in part I above](#PartI) and we are able to get the authentication keys for the API, we can easily fetch data from twitter in R. The following steps will help us do this:
...
[**here**](http://cran.cnr.berkeley.edu/). The code chunk below installs and loads the specific packages we need for this task. Take note of comments at each line of code, initiated by an octothorp.
...
You can now manipulate your data and see what you find out. Remember, **In data we trust!** 

<center>
![Happy crunching!!](https://media.giphy.com/media/ZtMkorgeyRu5q/giphy.gif)
</center>
